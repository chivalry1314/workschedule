...
let ScheduleWindowsModule = class ScheduleWindowsModule {
};
ScheduleWindowsModule = __decorate([
    Module({
        imports: [AuthModule],
...
export { ScheduleWindowsModule };
//# sourceMappingURL=schedule-windows.module.js.map