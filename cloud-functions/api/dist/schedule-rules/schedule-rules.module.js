...
let ScheduleRulesModule = class ScheduleRulesModule {
};
ScheduleRulesModule = __decorate([
    Module({
        imports: [AuthModule],
...
export { ScheduleRulesModule };
//# sourceMappingURL=schedule-rules.module.js.map